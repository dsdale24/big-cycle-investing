...
- **Contemporary US-specific accelerants (one mechanism among several, not the load-bearing driver):** 2020s unilateral military engagements without broad ally coalitions (Venezuela, Iran), weaponization of SWIFT / dollar-clearing infrastructure for sanctions (2012 Iran, 2014/2022 Russia), strained alliances with traditional coalition partners. These erode trust-based demand for USD-denominated assets among non-US sovereigns. They are part of the broader hegemony-decline dynamic, not a separate or optional feature.
...
**2026-04-15 — UK sterling transition, first transition-scale test (#52 Phase A).** The BoE "A Millennium of Macroeconomic Data" (v3.1) annual series for the UK 1900-1980 were loaded and examined against a timeline of the sterling transition's anchoring events (WW1, 1925 gold return, 1931 crisis, WW2, Bretton Woods, 1949 devaluation, Suez, 1967 devaluation, 1976 IMF bailout). See `docs/research/uk_sterling_transition.md` and `notebooks/04_uk_sterling_transition.ipynb`. **Qualitative call: the Dalio fiscal-deterioration → monetization pattern is clearly visible, with important refinements.** UK debt/GDP tripled to ~260% by 1947 (war-driven) and deleveraged only ~25ppt over the subsequent 35 years — austerity did not do the work. Bank-Rate-minus-CPI-inflation was deeply negative in 1915-1920, 1940-1948, and 1972-1979 — functional monetization via financial repression rather than formal balance-sheet expansion. Sterling depreciated ~65% against USD across the window, with every major devaluation aligning with the named events. Long-duration gilts lost 60-70% in real terms 1945-1980. **Important refinement: listed equity did NOT preserve purchasing power** (UK shares ended 1980 at ~70 real, 1945=100; ~25-30% real loss despite being a "real asset"). Tangible real assets (houses ~220 real, agricultural land ~240 real) were the actually-protective allocation. This sharpens `bond-allocation.md`: the non-sovereign-core concept must be constructed around tangible real assets, not listed equity. It also sharpens the comparison to the modern US case: the UK had external shocks (two world wars) forcing the monetization path; the US has internal-politics-driven fiscal dynamics producing ~6% structural peacetime deficits without the wartime excuse — which makes the US precedent arguably worse than the UK one. N=1 transition-scale evidence; Phases B (Dutch), C (JST panel), D (Chinese dynastic) should either replicate or refine this pattern. Data gap: sterling reserve-share data is not in the BoE workbook and requires a separate source (Eichengreen/Flandreau, Schenk, or IMF historical records) — flagged as follow-up. **Evidence for the thesis, N=1, supporting without settling.**
